            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-table"></i><a href="{{route('user.index')}}">All Users Table</a></li>
                    </ul>
                </li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa fa-table"></i><a href="{{route('main_category.index')}}">All Main Category Table</a></li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa fa-table"></i><a href="{{route('sub-category.index')}}">All Sub Category Table</a></li>
                        {{-- <li><i class="menu-icon fa fa-street-view"></i><a href="maps-vector.html">Cr</a></li> --}}
                    </ul>
                </li>
