...
<div class="container">
        ...
        <div class="col-md-4 order-md-2 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <p>{{$cart->subCategory->name}} X {{$cart->quantity}}</p>
                        </div>
                        <div class="col-md-4"></div>
                        <div class="col-md-4">
                            <p><span id="subTotal">{{$cart->price * $cart->quantity}}</span>Tk</p>
                        </div>
                    </div>
                    <hr>
                    @endforeach
                    <div class="row">
                        ...
                        <div class="col-md-4"></div>
                        <div class="col-md-4">
                            <p><span id="subTotal">50</span>Tk</p>
                        </div>
                    </div>
                    {{-- <hr> --}}
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <input type="hidden" name="amount" id="total_amount" value="{{$total}}" required/>
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">&copy; 2022 Grocery-Shop</p>
