...
class SslCommerzPaymentController extends Controller
{
    ...
    {
        return view('front.home.exampleEasycheckout');
    }
    ...
    public function exampleHostedCheckout()
    {
        ...
        if(count($carts) < 1){
            ...
            return view('front.home.exampleHosted', compact('user', 'carts'));
        }
    }
    ...
    public function index(Request $request)
    {
        ...
        $user = Auth::user();
        // $update_product = Order::getInsertId([
        ...
        //     ]);
           $order = new Order();
           $order->name = $post_data['cus_name'];
           $order->email = $post_data['cus_email'];
           $order->phone = $post_data['cus_phone'];
           $order->amount = $post_data['total_amount'];
           ...
           $order->payment_type = 'SSL';
            $order->id;
            $order->save();
            // $order_id = DB::table('orders')->insertGetId($update_product);
            // $order_id = Order::getInsertId($update_product);
            $carts = Cart::Where('user_id',$user->id)->get();
